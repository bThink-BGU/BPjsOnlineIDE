...
public class ServiceTest {
	...
	public void firstStep() {  	
    	...
    	try {
			...
			assertEquals(nextStepMessage.getGlobalVars().size(), 4);
			
			assertEquals(nextStepMessage.getGlobalVals().size(), 4);
	...
	public void lastStep() {
		...
		try {
    		...
    		assertEquals(stepMessage.getGlobalVars(), null);
			assertEquals(stepMessage.getGlobalVals(), null);
